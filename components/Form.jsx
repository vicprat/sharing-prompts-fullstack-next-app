  ...
  return (
    <section className='w-full max-w-full flex-start flex-col'>
      ...
      <p className='desc text-left max-w-md'>
        {type} a post to the community, and let your imagination run wild with AI-powered platform.
      </p>

      <form 
      onSubmit={handleSubmit}
      className='mt-10 w-full max-w-2xl flex flex-col gap-7 glasssmorphism' 
      >
        <label>
